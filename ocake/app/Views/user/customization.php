        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6 col-12">
                <div class="breadcrumbs-content">
                    <h1 class="page-title">
                        <?//php echo $occasion?> Start Design
                    </h1>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-12">
...
<div class="container mb-5">
    <div class="row">
        <div class="col-md-3 mt-2">
                    ...
                    <div class="p-1 d-flex cake-layer-item items">
                        <div class="p-1 image-card">
                            <img style="width:30px; height:30px"
                                src="https://png.pngtree.com/element_our/20190529/ourmid/pngtree-black-and-white-line-drawing-three-layer-cake-vector-icon-material-image_1197067.jpg"
                                alt="" />
                        </div>
                        <div class="p-1">
                            <span>
            ...
            <div class="p-2">
                <button class="btn btn-primary btn-lg" onclick="createCakePrev()"
                    style="width:100px; background-color:#cda808; border-color:#cda808;" data-bs-toggle="modal"
                    data-bs-target="#designModal">Save</button>
            </div>
        </div>
        <div class="col-md-6">
...
<!-- Modal -->
<div class="modal fade" id="designModal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
