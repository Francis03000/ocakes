                    ...
                    <div class="row align-items-center">
                            ...
                            <div class="product-image ">
                                <a href="<?= site_url('productdetail') ?>">
                                    ...
                                    <span><img style="height:100px;"
                                            ...
                                            alt="<?php echo $data->flavor;?>"></span>
                                    <?php }else{?>
                                    <img style="height:100px;" src="<?php echo $data->image;?>"
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
                            ...
                            <p class="product-des">
                                ...
                                <span><em>Unit Price:</em>
                                    <p id='price'><?php echo '&#8369;' . number_format ($data->price); ?></p>
                                </span>
                        ...
                        <div class="col-lg-2 col-md-2 col-12">
							...
							<span class="btn btn-lg inc" prod_id="'.$order->prod_id.'">+</span> -->
                                ...
                                <input class='quan' id="number" type="text" name="quantity" value="1" maxlength="2"
                                    max="10" style="width: 50px; text-align:center" />
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-6 col-12">
                                <div class="right">
                                    <ul>
                                        <li>Cart
                                            Subtotal<span><?php echo '&#8369;' . number_format ($subtotal). ".00"; ?></span>
                                        </li>
                                    </ul>
                                    <div class="button">
