        ...
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-12 col-12">
                <div class="content-left">
                    <img src="tools/user/images/about/about-img.jpg" alt="#">
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-team">
                    <div class="image">
                        <img src="tools/user/images/team/01.jpg" alt="#">
                    </div>
                    <div class="content">
                        <div class="info">
                            <h3>Grace Wright</h3>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-team">
                    <div class="image">
                        <img src="tools/user/images/team/02.jpg" alt="#">
                    </div>
                    <div class="content">
                        <div class="info">
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-team">
                    <div class="image">
                        <img src="tools/user/images/team/03.jpg" alt="#">
                    </div>
                    <div class="content">
                        <div class="info">
                            <h3>Quinton Cross</h3>
            ...
            <div class="col-lg-3 col-md-6 col-12">
                ...
                <div class="single-team">
                    <div class="image">
                        <img src="tools/user/images/team/04.jpg" alt="#">
                    </div>
                    <div class="content">
                        <div class="info">
                            <h3>Liana Mullen</h3>
