...
<div class="btn-group mt-3 " style="margin-left:8%">
  ...
  <a href="<?=site_url('completedorder')?>" class="btn btn-primary" role="button" style="background-color:#cda808; border-color:#cda808; color:#0d0e0f">Completed</a>
...
<div class="mt-5 mb-5">
    <div class="container">
        <div class="cart-list-head">
            <div class="p-3 text-center text-lg  rounded-top" style="background-color:#cda808; color:#0d0e0f"><span class="text-uppercase">Completed Orders </span></div>
