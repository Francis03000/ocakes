...
<script src="<?=base_url()?>/tools/admin/assets/plugins/flot/jquery.flot.js"></script>
<script src="<?=base_url()?>/tools/admin/assets/plugins/flot/jquery.flot.fillbetween.js"></script>
<script src="<?=base_url()?>/tools/admin/assets/plugins/flot/jquery.flot.pie.js"></script>
<script src="<?=base_url()?>/tools/admin/assets/plugins/flot/chart-data.js"></script>
