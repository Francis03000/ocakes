        ...
        <div class="content">
          <div class="page-header">
            <div class="page-title">
              <h4>Product Flavor list</h4>
              <h6>View/Search cake Flavor</h6>
            </div>
            <div class="page-btn">
              <a type="button" class="btn btn-added">
                <img src="<?=base_url()?>/tools/admin/assets/img/icons/plus.svg" class="me-1" alt="img" data-toggle="modal" data-target="#myModal"/>Add Flavor
              </a>
            </div>
          </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                ...
                <div class="modal-content" style="width:600px">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="container mt-2" action="<?=site_url('admin/addflavor')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                              ...
                              <div class="col-lg-3 col-12">
                                  <label> Flavor Image</label>
                                      <div class="container mt-3">
                                        ...
                                        <div class="mt-2 mb-3">
                                            <input type="file" name="flavor_image" multiple="true" id="finput" onchange="onFileUpload(this);"
                                ...
                                <div class="col-lg-3 col-12">
                                    <label>Flavor</label>
                                    <input type="text" class="form-control" name="flavor"><br>

                                    <label>Flavor Status</label>
                                    <select class="select" name="flavor_status">
                      ...
                      foreach($flavor as $data){?>
                        <tr>
                          ...
                          <td class="productimgname">
                              ...
                              <img src="http://localhost/ocake/tools/uploads/<?php echo $data->flavor_image;?>" alt="no image">
                              </a>
                              <a href="javascript:void(0);"><?=$data->flavor;?></a>
                          </td>
                          <!-- <td><?//=$data->flavor;?></td> -->
                          <td>
                              <div>
                          ...
                          <td>
                              ...
                              <img src="<?=base_url()?>/tools/admin/assets/img/icons/edit.svg" alt="img" data-toggle="modal" data-target="#editModal<?php echo $data->flavor_id;?>"/>
                              </a>
                              <a class="me-3 confirm-text" href="<?php echo site_url('admin/flavorlist/delete_flavor/' . $data->flavor_id); ?>">
                              <img src="<?=base_url()?>/tools/admin/assets/img/icons/delete.svg" alt="img" />
                              </a>
                          </td>
                          <div class="container">
                              <!-- Modal -->
                              <div class="modal fade" id="editModal<?php echo $data->flavor_id;?>" role="dialog">
                                  <div class="modal-dialog">
                                  ...
                                  <div class="modal-content" style="width:600px">
                                      ...
                                      <div class="modal-body">
                                          <?php $validation = \Config\Services::validation();?>
                                          <form class="container mt-2" action="<?php echo site_url('admin/flavorlist/update_flavor/' . $data->flavor_id); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                          <?php if(session('success')){ echo session('success');}else{ echo session('error');}?>
                                              <div class="row">
                                                  <input type="hidden" name="flavor_id" value="<?php echo $data->flavor_id?>">
                                                      ...
                                                      <div class="mt-3">
                                                          ...
                                                          <div class="d-grid text-center">
                                                              <img class="mb-3" id="ajaxImgUpload" style="height:100px; width:100px; margin-left:30%"
                                                                  alt="Preview Image"
                                                                  src="http://localhost/ocake/tools/uploads/<?php echo $data->flavor_image;?>" />
                                                          </div>
                                                          <div class="mb-3">
                                                              <input type="file" name="flavor_image"
                                                  ...
                                                  <div class="col-lg-6 col-12">
                                                      ...
                                                      <input type="text" class="form-control" name="flavor" value="<?php echo $data->flavor?>"><br>
