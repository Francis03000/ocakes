            ...
            <div class="top-nav-search">
              ...
              <form action="#">
                ...
                <a class="btn" id="searchdiv"
                  ><img src="<?=base_url()?>/tools/admin/assets/img/icons/search.svg" alt="img"
                /></a>
              </form>
            </div>
          </li>
                ...
                <ul class="notification-list">
                    ...
                    <a href="activities.html">
                      <div class="media d-flex">
                        <span class="avatar flex-shrink-0">
                          <img alt="" src="<?=base_url()?>/tools/admin/assets/img/profiles/avatar-02.jpg" />
                        </span>
                  ...
                  <li class="notification-message">
                    <a href="activities.html">
                      <div class="media d-flex">
                        <span class="avatar flex-shrink-0">
                          <img alt="" src="<?=base_url()?>/tools/admin/assets/img/profiles/avatar-03.jpg" />
                        </span>
                        <div class="media-body flex-grow-1">
                          <p class="noti-details">
                  ...
                  <li class="notification-message">
                    <a href="activities.html">
                      <div class="media d-flex">
                        <span class="avatar flex-shrink-0">
                          <img alt="" src="<?=base_url()?>/tools/admin/assets/img/profiles/avatar-06.jpg" />
                        </span>
                        <div class="media-body flex-grow-1">
                          <p class="noti-details">
                  ...
                  <li class="notification-message">
                    <a href="activities.html">
                      <div class="media d-flex">
                        <span class="avatar flex-shrink-0">
                          <img alt="" src="<?=base_url()?>/tools/admin/assets/img/profiles/avatar-17.jpg" />
                        </span>
                        <div class="media-body flex-grow-1">
                          <p class="noti-details">
                  ...
                  <li class="notification-message">
                    <a href="activities.html">
                      <div class="media d-flex">
                        <span class="avatar flex-shrink-0">
                          <img alt="" src="<?=base_url()?>/tools/admin/assets/img/profiles/avatar-13.jpg" />
                        </span>
                        <div class="media-body flex-grow-1">
                          <p class="noti-details">
            ...
            <div class="dropdown-menu menu-drop-user">
              <div class="profilename">
                ...
                <a class="dropdown-item logout pb-0" href="<?=site_url('admin')?>">
                  <img src="<?=base_url()?>/tools/admin/assets/img/icons/log-out.svg" class="me-2" alt="img"/>Logout
                </a>
              </div>
            </div>
          </li>
