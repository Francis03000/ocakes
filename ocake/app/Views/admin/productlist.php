    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            <div class="content">
                ...
                <div class="page-btn">
                <a type="button" class="btn btn-added"><img src="<?=base_url()?>/tools/admin/assets/img/icons/plus.svg" alt="img" class="me-1" data-toggle="modal" data-target="#myModal">Add New Product</a>
            </div>
        </div>
        <div class="container">
            <!-- Modal -->
            <div class="modal fade" id="myModal" role="dialog">
                ...
                <div class="modal-content" style="width:600px">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="container mt-2" action="<?=site_url('admin/addproduct')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <?php if(session('success')){ echo session('success');}else{ echo session('error');}?>
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <select id="mySelect" onchange="myFunction()" class="select" name="occasion">
                                        ...
                                        <option value="<?php echo $data->category_name;?>,<?php echo $data->category_id;?>"><?php echo $data->category_name;?></option>
                                            <?php }?>
                                    </select><br><br>
                            ...
                            <div class="modal-footer" style="padding-left:25%">
                                <button type="button" class="btn btn-secondary btn-lg"
                                    ...
                                    <input class="btn btn-success btn-lg" type="submit" value="Add" name="submit" style="width:100px">
                            </div>
                        </form>
                    </div>
                </div>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a class="me-3" type="button">
                            <img src="<?=base_url()?>/tools/admin/assets/img/icons/edit.svg" alt="img" data-toggle="modal" data-target="#editModal<?php echo $data->id;?>">
                            </a>
                            <a class="confirm-text" href="<?php echo site_url('admin/productlist/delete_prod/' . $data->id); ?>">
                        ...
                        <div class="container">
                            ...
                            <div class="modal fade" id="editModal<?php echo $data->id;?>" role="dialog">
                                ...
                                <div class="modal-content" style="width:600px">
                                    ...
                                    <div class="modal-body">
                                        <?php $validation = \Config\Services::validation();?>
                                        <form class="container mt-2" action="<?php echo site_url('admin/productlist/update_prod/' . $data->id); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                        <?php if(session('success')){ echo session('success');}else{ echo session('error');}?>
                                            <div class="row">
                                                ...
                                                <div class="col-lg-6 col-12">
                                                    ...
                                                    <div class="mt-3">
                                                        ...
                                                        <div class="d-grid text-center">
                                                            <img class="mb-3" id="ajaxImgUpload" style="float:center;margin-left:25%"
                                                                alt="Preview Image"
