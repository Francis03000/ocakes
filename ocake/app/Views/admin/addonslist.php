        ...
        <div class="content">
          <div class="page-header">
            <div class="page-title">
              <h4>Product AddOns list</h4>
              <h6>View/Search AddOns</h6>
            </div>
            <div class="page-btn">
              <a type="button" class="btn btn-added">
                <img src="<?=base_url()?>/tools/admin/assets/img/icons/plus.svg" class="me-1" alt="img" data-toggle="modal" data-target="#myModal"/>Add AddOns
              </a>
            </div>
          </div>
            ...
            <div class="modal fade" id="myModal" role="dialog">
                ...
                <div class="modal-content" style="width:600px">
                    ...
                    <div class="modal-body">
                        ...
                        <form class="container mt-2" action="<?=site_url('admin/add_addons')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        <?php if(session('success')){ echo session('success');}else{ echo session('error');}?>
                        <div class="row">
                              <div class="col-lg-3 col-12">
                                  <label> AddOns Image</label>
                                ...
                                <div class="col-lg-3 col-12">
                                    ...
                                    <label>AddOns Status</label>
                                    <select class="select" name="addons_status">
                      ...
                      foreach($addons as $data){?>
                        <tr>
                          ...
                          <td class="productimgname">
                              ...
                              <img src="http://localhost/ocake/tools/uploads/<?php echo $data->image;?>" alt="no image">
                              </a>
                          ...
                          <td>
                              ...
                              <img src="<?=base_url()?>/tools/admin/assets/img/icons/edit.svg" alt="img" data-toggle="modal" data-target="#editModal<?php echo $data->add_ons_id;?>"/>
                              </a>
                              <a class="me-3 confirm-text" href="<?php echo site_url('admin/addonslist/delete_addons/' . $data->add_ons_id); ?>">
                              <img src="<?=base_url()?>/tools/admin/assets/img/icons/delete.svg" alt="img" />
                              </a>
                          </td>
                          <div class="container">
                              <!-- Modal -->
                              <div class="modal fade" id="editModal<?php echo $data->add_ons_id;?>" role="dialog">
                                  <div class="modal-dialog">
                                  ...
                                  <div class="modal-content" style="width:600px">
                                      ...
                                      <div class="modal-body">
                                          <?php $validation = \Config\Services::validation();?>
                                          <form class="container mt-2" action="<?php echo site_url('admin/addonslist/update_addons/' . $data->add_ons_id); ?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                                          <?php if(session('success')){ echo session('success');}else{ echo session('error');}?>
                                              <div class="row">
                                                  <input type="hidden" name="add_ons_id" value="<?php echo $data->add_ons_id?>">
                                                  ...
                                                  <div class="col-lg-6 col-12">
                                                      <label>AddOns</label>
                                                      <input type="text" class="form-control" name="description" value="<?php echo $data->description?>"><br>

                                                      <label>Price</label>
                                                      <input type="text" class="form-control" name="price" value="<?php echo $data->price?>"><br>

                                                      <label>Quantity</label>
                                                      <input type="text" class="form-control" name="quantity" value="<?php echo $data->quantity?>"><br>
